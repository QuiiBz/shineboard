...
class EmbedController extends Controller
{
    ...
    public function embed(Request $request, string $slug): \Illuminate\Http\Response
    {
        ...
        $js .= 'document.write("<div class=\'shineboard-embed\'><div class=\'header\'><p class=\'title\'>' .$paste->title. '</p></div><div class=\'paste\'><pre class=\'language-\'><code class=\'language-\'>' .$paste->code. '</code></pre></div></div>");';
